...
df1 = pd.read_csv('/Volumes/lab-windingm/home/users/cochral/AttractionRig/analysis/social-isolation/holes/N10-1-HOLE/GROUP-HOUSED/interaction_status_type.csv')
df1['condition'] = 'GH'

df2 = pd.read_csv('/Volumes/lab-windingm/home/users/cochral/AttractionRig/analysis/social-isolation/holes/N10-1-HOLE/SOCIAL-ISOLATION/interaction_status_type.csv')
df2['condition'] = 'SI'
...
plt.savefig('/Users/cochral/repos/behavioural-analysis/plots/socially-isolated/holes/interactions/interaction-status_duration.png', dpi=300, bbox_inches='tight')
