...
### N10
df1 = pd.read_csv('/Volumes/lab-windingm/home/users/cochral/AttractionRig/analysis/social-isolation/n10/socially-isolated/time_average_msd.csv')
df2 = pd.read_csv('/Volumes/lab-windingm/home/users/cochral/AttractionRig/analysis/social-isolation/n10/group-housed/time_average_msd.csv')
### N1
...
### N10
sns.lineplot(data=df1, x='tau', y='msd', ci=None, label='si_n10')
sns.lineplot(data=df2, x='tau', y='msd', ci=None, label='gh_n10')
# ### N1
