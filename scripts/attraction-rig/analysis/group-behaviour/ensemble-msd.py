...
### N2
sns.lineplot(data=df5, x='time', y='squared_distance',  color=PALETTE["group-housed"], errorbar='sd', label='GH')
sns.lineplot(data=df6, x='time', y='squared_distance',  color=PALETTE["socially-isolated"], errorbar='sd', label='SI')
...
plt.savefig('/Users/cochral/repos/behavioural-analysis/plots/socially-isolated/ensemble-msd/n10.png', dpi=300, bbox_inches='tight')
plt.savefig('/Users/cochral/repos/behavioural-analysis/plots/socially-isolated/ensemble-msd/n10.pdf', dpi=300, bbox_inches='tight') 
