...
df1 = pd.read_csv('/Volumes/lab-windingm/home/users/cochral/LRS/AttractionRig/analysis/social-isolation/n10/socially-isolated/speed_over_time.csv')
df1['condition'] = 'SI'

df2 = pd.read_csv('/Volumes/lab-windingm/home/users/cochral/LRS/AttractionRig/analysis/social-isolation/pseudo-n10/socially-isolated/speed_over_time.csv')
...
for cond in counts['condition'].unique():
    ...
    plt.savefig(f'/Users/cochral/repos/behavioural-analysis/plots/lrs_paper/GS/siXpseudo/speed_{cond}.pdf', format='pdf', bbox_inches='tight')
