...
df = df[df['Closest Interaction Type'] == 'head_head'].copy()
...
for label, x in tick_x.items():
    ...
    ax.text(
        ...
        260,    # slightly above tallest bar in that category
        stars,
        ha="center",
        va="bottom",
        fontsize=14,
...
plt.savefig('/Users/cochral/repos/behavioural-analysis/plots/lrs_paper/GS/siXpseudo/interaction_type-closestnode_n10_pseudo_h-h.pdf', 
